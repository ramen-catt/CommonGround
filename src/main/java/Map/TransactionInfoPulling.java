/*
this is where the transaction info is pulled from the database
the transaction id also contains the buyer and seller ids which contains their addresses
 */
...
//placing the users info in the user objects
            if (rs.next()) {
